...
def rd_hdl():
    return dumper.RomDumper(rom_file=rom_file, xml_def_file=def_file, verbose = verbose)
...
def dump_all_cli(args):
    rd = dumper.RomDumper(rom_file=args.rom_file, xml_def_file=args.def_file, verbose = verbose)
